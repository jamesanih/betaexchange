...
<div class="about">
 ...
 <div class="alert alert-info text-center" style="margin-top: 20px">
  <strong>Attention!</strong> If you did not receive  your verification code on your mobile phone,  please call the admin on (+234) 809-519-3030 or 08038014771. Thanks.
</div>
            </div>
         @if (count($errors) > 0)
