...
<div class="tab-content">
  <div id="home" class="tab-pane fade in active">
                         @if (Session::has('message'))
                             <div class="alert alert-info text-center"  role="alert" id="msg">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="sold_bitcoins">
                    ...
                    <tr>
                        ...
                        <td id="delrow"><a href='#delete_bit_modal' data-delete-id='{!! $bitcoins->id!!}' class='btn btn-danger deleteBtn' role='button' data-toggle='modal'><i class='fa fa-trash-o fa-lg'></i></a></td>
